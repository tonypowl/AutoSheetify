  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-center items-center max-w-7xl mx-auto px-6 gap-8 md:gap-4">
        ...
        <div className="relative hidden md:flex justify-center items-center w-[120px] min-w-[120px]">
        ...
        <div className="relative hidden md:flex justify-center items-center w-[80px] min-w-[80px]">
